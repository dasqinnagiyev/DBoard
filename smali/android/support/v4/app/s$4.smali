...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/app/s;->b(Landroid/support/v4/app/u;Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/f/a;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
.end annotation
...
# direct methods
.method constructor <init>(Landroid/support/v4/app/u;Landroid/support/v4/f/a;Ljava/lang/Object;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Landroid/view/View;Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLjava/util/ArrayList;Ljava/lang/Object;Landroid/graphics/Rect;)V
    .locals 0
    ...
    iput-object p7, p0, Landroid/support/v4/app/s$4;->g:Landroid/support/v4/app/h;

    iput-object p8, p0, Landroid/support/v4/app/s$4;->h:Landroid/support/v4/app/h;
...
.method public run()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/s$4;->g:Landroid/support/v4/app/h;

    iget-object v2, p0, Landroid/support/v4/app/s$4;->h:Landroid/support/v4/app/h;

    iget-boolean v3, p0, Landroid/support/v4/app/s$4;->i:Z

    const/4 v4, 0x0

    invoke-static {v1, v2, v3, v0, v4}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Z)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/s$4;->l:Landroid/graphics/Rect;

    invoke-virtual {v1, v0, v2}, Landroid/support/v4/app/u;->a(Landroid/view/View;Landroid/graphics/Rect;)V
