...
.method private static a(Landroid/support/v4/app/u;Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/f/a;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    invoke-static {v6, v1, v5, v7}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/u;Landroid/support/v4/f/a;Ljava/lang/Object;Landroid/support/v4/app/s$a;)Landroid/support/v4/f/a;

    move-result-object v12

    invoke-static {v6, v1, v5, v7}, Landroid/support/v4/app/s;->c(Landroid/support/v4/app/u;Landroid/support/v4/f/a;Ljava/lang/Object;Landroid/support/v4/app/s$a;)Landroid/support/v4/f/a;
    ...
    invoke-static {v2, v12, v14}, Landroid/support/v4/app/s;->a(Ljava/util/ArrayList;Landroid/support/v4/f/a;Ljava/util/Collection;)V

    invoke-virtual/range {p3 .. p3}, Landroid/support/v4/f/a;->values()Ljava/util/Collection;

    move-result-object v1

    invoke-static {v3, v13, v1}, Landroid/support/v4/app/s;->a(Ljava/util/ArrayList;Landroid/support/v4/f/a;Ljava/util/Collection;)V
    ...
    invoke-static {v9, v10, v11, v12, v1}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Z)V
    ...
    invoke-static/range {v0 .. v5}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/u;Ljava/lang/Object;Ljava/lang/Object;Landroid/support/v4/f/a;ZLandroid/support/v4/app/c;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    invoke-static {v13, v7, v8, v11}, Landroid/support/v4/app/s;->b(Landroid/support/v4/f/a;Landroid/support/v4/app/s$a;Ljava/lang/Object;Z)Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v7}, Landroid/support/v4/app/s$3;-><init>(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Landroid/view/View;Landroid/support/v4/app/u;Landroid/graphics/Rect;)V
...
.method private static a(Landroid/support/v4/app/c;Landroid/support/v4/app/c$a;Landroid/util/SparseArray;ZZ)V
    ...
    :cond_0
    iget v11, v10, Landroid/support/v4/app/h;->z:I
    ...
    iget-boolean v1, v10, Landroid/support/v4/app/h;->Q:Z

    if-eqz v1, :cond_9

    iget-boolean v1, v10, Landroid/support/v4/app/h;->B:Z

    if-nez v1, :cond_9

    iget-boolean v1, v10, Landroid/support/v4/app/h;->l:Z
    ...
    iget-object v1, v10, Landroid/support/v4/app/h;->J:Landroid/view/View;
    ...
    iget v1, v10, Landroid/support/v4/app/h;->R:F
...
.method static synthetic a(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Z)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Z)V

    return-void
.end method

.method private static a(Landroid/support/v4/app/n;ILandroid/support/v4/app/s$a;Landroid/view/View;Landroid/support/v4/f/a;)V
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v8}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/u;Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/f/a;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method static a(Landroid/support/v4/app/n;Ljava/util/ArrayList;Ljava/util/ArrayList;IIZ)V
    ...
    invoke-static {v4, p1, p2, p3, p4}, Landroid/support/v4/app/s;->a(ILjava/util/ArrayList;Ljava/util/ArrayList;II)Landroid/support/v4/f/a;
    ...
    invoke-static {p0, v4, v6, v1, v5}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/n;ILandroid/support/v4/app/s$a;Landroid/view/View;Landroid/support/v4/f/a;)V

    goto :goto_3

    :cond_3
    invoke-static {p0, v4, v6, v1, v5}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/n;ILandroid/support/v4/app/s$a;Landroid/view/View;Landroid/support/v4/f/a;)V
...
.method private static a(Landroid/support/v4/app/u;Ljava/lang/Object;Landroid/support/v4/app/h;Ljava/util/ArrayList;)V
    ...
    iget-boolean v0, p2, Landroid/support/v4/app/h;->l:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p2, Landroid/support/v4/app/h;->B:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p2, Landroid/support/v4/app/h;->Q:Z
    ...
    iget-object p0, p2, Landroid/support/v4/app/h;->I:Landroid/view/ViewGroup;
...
.method private static b(Landroid/support/v4/app/u;Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/f/a;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    invoke-static {v6, v13, v1, v7}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/u;Landroid/support/v4/f/a;Ljava/lang/Object;Landroid/support/v4/app/s$a;)Landroid/support/v4/f/a;
    ...
    invoke-static {v8, v9, v12, v3, v1}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Z)V
    ...
    invoke-direct/range {v0 .. v12}, Landroid/support/v4/app/s$4;-><init>(Landroid/support/v4/app/u;Landroid/support/v4/f/a;Ljava/lang/Object;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Landroid/view/View;Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLjava/util/ArrayList;Ljava/lang/Object;Landroid/graphics/Rect;)V
...
.method private static b(Landroid/support/v4/app/h;Landroid/support/v4/app/h;ZLandroid/support/v4/f/a;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static b(Landroid/support/v4/app/n;ILandroid/support/v4/app/s$a;Landroid/view/View;Landroid/support/v4/f/a;)V
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v8}, Landroid/support/v4/app/s;->b(Landroid/support/v4/app/u;Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/f/a;Landroid/support/v4/app/s$a;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static c(Landroid/support/v4/app/u;Landroid/support/v4/f/a;Ljava/lang/Object;Landroid/support/v4/app/s$a;)Landroid/support/v4/f/a;
    ...
    :cond_5
    invoke-static {p1, p2}, Landroid/support/v4/app/s;->a(Landroid/support/v4/f/a;Landroid/support/v4/f/a;)V
